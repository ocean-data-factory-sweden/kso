...
from yolov5.utils.datasets import LoadImages, LoadStreams, VID_FORMATS # noqa: E402
...
from yolov5.utils.torch_utils import select_device, time_sync # noqa: E402
from yolov5.utils.plots import Annotator, colors, save_one_box # noqa: E402
from deep_sort.utils.parser import get_config # noqa: E402
...
def detect(opt):
    """
    It takes a video or a folder of images, runs YOLOv5 on each frame, and then runs DeepSort on the
    detections
    ...
    if type(yolo_model) is str:  # single yolo model
        ...
        type(yolo_model) is list and len(yolo_model) == 1
    ):  # single models after --yolo_model
